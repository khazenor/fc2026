StartupEvents.registry('sound_event', event => {
  ...
  event.create("farming_crossing_records:sky_penguin_midnight_frankum")
  event.create("farming_crossing_records:sky_penguin_stargazing_frankum")
  event.create("farming_crossing_records:sky_penguin_sunrise_frankum")
  event.create("farming_crossing_records:sky_penguin_together_migfus20")
})
...
StartupEvents.registry('item', event => {
  ...
  event.create("kubejs:oneul_winter_glow")
    ...
    .maxStackSize(64)
  event.create("kubejs:sky_penguin_midnight_frankum")
    .jukeboxPlayable("kubejs:sky_penguin_midnight_frankum", true)
    .texture("farming_crossing_records:item/sky_penguin_midnight_frankum")
    .displayName("Music Disc: Sky Penguin - Midnight - frankum")
    .maxStackSize(64)
  event.create("kubejs:sky_penguin_stargazing_frankum")
    .jukeboxPlayable("kubejs:sky_penguin_stargazing_frankum", true)
    .texture("farming_crossing_records:item/sky_penguin_stargazing_frankum")
    .displayName("Music Disc: Sky Penguin - Stargazing - frankum")
    .maxStackSize(64)
  event.create("kubejs:sky_penguin_sunrise_frankum")
    .jukeboxPlayable("kubejs:sky_penguin_sunrise_frankum", true)
    .texture("farming_crossing_records:item/sky_penguin_sunrise_frankum")
    .displayName("Music Disc: Sky Penguin - Sunrise - frankum")
    .maxStackSize(64)
  event.create("kubejs:sky_penguin_together_migfus20")
    .jukeboxPlayable("kubejs:sky_penguin_together_migfus20", true)
    .texture("farming_crossing_records:item/sky_penguin_together_migfus20")
    .displayName("Music Disc: Sky Penguin - Together - migfus20")
    .maxStackSize(64)
})